		...
		tmr.scheduleAtFixedRate(new TimerTask() {
			...
			public void run() {
				...
				if (TextUtils.isEmpty(lastEnabled)) {
					lastEnabled = "com.dgtech.neat.SplashScreenActivity";
				}

				ComponentName componentName = new ComponentName(
						"com.dgtech.neat", lastEnabled);
				...
				if (value <= 0) {
					...
					lastEnabled = "com.dgtech.neat.SplashScreenActivity.a" + value;
				} else {
					lastEnabled = "com.dgtech.neat.SplashScreenActivity.a10p";
				}

				componentName = new ComponentName("com.dgtech.neat.SplashScreenActivity",
						lastEnabled);
				pm.setComponentEnabledSetting(componentName,
