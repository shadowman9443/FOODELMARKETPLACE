...
public final class SharedPreferencesHelper {
	...
	public static final String REMEMBER = "skthai_remember";

	// App Preferences
	private static final String PREFS_FILE_NAME = "skthai_AppPreferences";
	private static final String PREF_TAB_FEED_KEY = "skthai_tabFeed";

	private static final String USER = "skthai_user";
	private static final String JSONDATA = "skthai_JSONDATA";

	private static final String PASS = "skthai_pass";

	private static final String RADIUS = "skthai_radius";
	private static final String ZOOM = "skthai_zoom";
	private static String ONLINE = "skthai_online";
	public static final String NULL = "";
	private static final String STATATIONURL = "skthai_stationurl";
	private static final String STATAIONTYPE = "skthai_stationtype";
	private static final String FIRSTTime = "skthai_FIRSTTime";
	private static final String REGID = "skthai_REG_ID";
	
	
	private static final String NOTIFICATION_URL = "skthai_notificatiourl";
	
	/********************************For Update Settings**************************************/
	
	public static String getSettingsUrl(final Context ctx) {
		return ctx.getSharedPreferences(
				SharedPreferencesHelper.PREFS_FILE_NAME, Context.MODE_PRIVATE)
				.getString(SharedPreferencesHelper.NOTIFICATION_URL, "");
	}
	public static void setSettingsUrl(final Context ctx, final String string) {
		final SharedPreferences prefs = ctx.getSharedPreferences(
				PREFS_FILE_NAME, Context.MODE_PRIVATE);
		final Editor editor = prefs.edit();
		editor.putString(NOTIFICATION_URL, string);
		editor.commit();
	}
	...
	public static String getRegID(final Context ctx) {
		return ctx.getSharedPreferences(
				SharedPreferencesHelper.PREFS_FILE_NAME, Context.MODE_PRIVATE)
				.getString(SharedPreferencesHelper.REGID, "");
	}

	public static void setRegID(final Context ctx, final String string) {
		final SharedPreferences prefs = ctx.getSharedPreferences(
				PREFS_FILE_NAME, Context.MODE_PRIVATE);
		final Editor editor = prefs.edit();
		editor.putString(REGID, string);
		editor.commit();
	}
